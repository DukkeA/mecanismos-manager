...
const heading = Signika_Negative({
  subsets: ["latin"],
  weight: ["600", "700"],
...
export const metadata: Metadata = {
  title: "Mecanismos Manager",
  description: "Gestión interna de Mecanismos Técnicos SAS",
...
export default function RootLayout({
  ...
  return (
    <html
      lang="es-CO"
      className={cn("font-sans", geist.variable, heading.variable)}
    >
      <body>
        {children}
        <PwaRegister />
